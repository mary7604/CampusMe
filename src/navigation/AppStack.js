...
export default function AppStack() {
  return (
    <Stack.Navigator screenOptions={headerOptions}>
      ...
      <Stack.Screen name="Announcements"       options={{ headerShown: false }}             component={AnnouncementsScreen} />
      <Stack.Screen name="AnnouncementDetail"  options={{ headerShown: false }}             component={AnnouncementDetailScreen} />
      <Stack.Screen name="StudentGrades"       options={{ title: "Notes de l'etudiant" }}  component={StudentGradesScreen} />
    </Stack.Navigator>
  );
}